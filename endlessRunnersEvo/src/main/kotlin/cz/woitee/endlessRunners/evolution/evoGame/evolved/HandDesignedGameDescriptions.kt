...
fun bitTriEvolvedGameDescription(): EvolvedGameDescription {
    ...
    newChromosomes.add(
        sampleGenotype[1].newInstance(
            ISeq.of(
                { customObjectGene(true) },
                4
            )
        )
    )
